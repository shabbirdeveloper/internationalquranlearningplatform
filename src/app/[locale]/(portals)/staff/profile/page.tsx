...
import { StaffProfilePage } from "@/components/portal/profile-pages";
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const path = `/${locale}/staff/profile`;
  ...
  return <StaffProfilePage locale={locale} snapshot={await getStaffPortalSnapshot(access)} dictionary={dictionary} />;
}
